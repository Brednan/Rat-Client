...
DEPENDENCIES_OBJ_FILES = ./dependencies/object-files/*.s
INCLUDE_DIR = ./include/
...
test:
	g++ $(SOURCE_FILES) $(DEPENDENCIES_OBJ_FILES) -I $(INCLUDE_DIR) -I $(DEPENDENCIES_INCLUDE_DIR) -L $(DEPENDENCIES_LIB_DIR) -lcurl -liphlpapi -lcrypto